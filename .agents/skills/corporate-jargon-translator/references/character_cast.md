# Character Cast: Lala Company & Corporate Archetypes

This reference file defines the character personas available in **Character Commentary Mode**. When translating corporate announcements, emails, or meeting transcripts, the agent can invoke these characters to provide multi-perspective commentary.
...
## 💬 Sample Multi-Character Panel Conversation Format
