...
1. **Decode Mode**: Decodes HR speak, meeting transcripts, PIP emails, and IPO hype — inline 🎙️ Translator commentary first, then a structured Markdown table with risk levels (🟢 Low, 🟡 Medium, 🟠 High, 🔴 Critical), plus 2-3 tactical employee survival tips.
...
3. **Character Commentary Mode (Lala Company Edition)**: Provides comedic panel reactions featuring *The Enlightened Founder*, *Lala Ji (self-proclaimed CEO — a different person from the Founder)*, *Sycophant Senior*, *Tired Dev Dave*, *Naive Joiner*, and *Unfiltered Translator*. Directly invocable via the `lala-panel` skill in `.agents/skills/lala-panel/`.
